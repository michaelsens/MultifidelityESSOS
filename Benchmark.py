...
res = minimize(low_loss, x0=all_dofs, method="L-BFGS-B", options={ 'maxiter': 15, "disp": False, "ftol": 1e-4, "gtol": 1e-4}, callback = callback_low, tol=1e-8)
...
t_low = time.time()
res = minimize(low_loss_time, x0=all_dofs, method="L-BFGS-B", options={ 'maxiter': 15, "disp": False, "ftol": 1e-4, "gtol": 1e-4}, callback = callback_low_time, tol=1e-8)
...
t_high = time.time()
res = minimize(high_loss, x0=all_dofs, method="L-BFGS-B", options={ 'maxiter': 15, "disp": False, "ftol": 1e-4, "gtol": 1e-4}, callback = callback_high, tol=1e-8)
